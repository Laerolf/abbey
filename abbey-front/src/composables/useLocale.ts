...
export default function useLocale(namespace?: string) {
  ...
  /**
   * Translates a given key using the i18n instance, optionally within a specified namespace.
   * @param key - The key to be translated, which can be prefixed with a namespace if provided.
